About compass-interface-core-feedstock
======================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/compass-interface-core-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11561&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/compass-interface-core-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `compass-interface-core` can be installed with `conda`:
...
```
mamba install compass-interface-core
```

It is possible to list all of the versions of `compass-interface-core` available on your platform with `conda`:
...
```
mamba search compass-interface-core --channel conda-forge
```
...
mamba repoquery search compass-interface-core --channel conda-forge

# List packages depending on `compass-interface-core`:
mamba repoquery whoneeds compass-interface-core --channel conda-forge

# List dependencies of `compass-interface-core`:
mamba repoquery depends compass-interface-core --channel conda-forge
```
